package com.belyakov.room.app.screens.main.auth
...
import com.belyakov.room.app.Repositories
import com.belyakov.room.databinding.FragmentSignUpBinding
import com.belyakov.room.app.model.accounts.entities.SignUpData
import com.belyakov.room.app.utils.observeEvent
import com.belyakov.room.app.utils.viewModelCreator
...
class SignUpFragment : Fragment(R.layout.fragment_sign_up) {
    ...
    private fun onCreateAccountButtonPressed() {
        val signUpData = SignUpData(
            ...
            password = binding.passwordEditText.text.toString().toCharArray(),
            repeatPassword = binding.repeatPasswordEditText.text.toString().toCharArray(),
        )
